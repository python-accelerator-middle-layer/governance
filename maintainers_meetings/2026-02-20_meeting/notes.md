...
- Alexis' report from the workshop working group
  ...
  - TO: KIT have some Measurement class -> maybe we should ask them to share it
...
- TO can work on documentation (some initial discussion with JLP) was done -> but she can start in a few weeks
- VG will ask Alexandre Moutardier if he can finish the chromaticity tuning tool
