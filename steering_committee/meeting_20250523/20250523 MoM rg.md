...
- What is the role of the coordinator? -> needs to be defined. Idea was to set the meetings, moderate them, and organize agenda.
- Definition of the three roles still TBD.
  ***->  A short description of the roles should be provided by the proposed people. Steering committee will review them.***
  - Proposed people are ready to commit time to the roles. We need a fast feedback loop between core team and testing team.
  - Who is involved in the demonstrator? -> all people on the maintainers list.
  - 
